...
**Parallelization:** Task 1 (scaffold) must complete first. After that, three groups can run in parallel: {Tasks 2+3: gateway skill}, {Tasks 4+5+6: browser skill}, {Tasks 7+8: markdown skill}. Tasks 9-10 (README, marketplace) depend on all prior tasks.
...
- [ ] **Step 0: Verify cmux CLI availability**

```bash
which cmux || echo "WARNING: cmux CLI not found in PATH — plugin will build but cannot be tested"
```
...
- Create: `plugins/claw-mux/skills/claw-mux/references/trigger-flash-and-health.md`
...
- [ ] **Step 4: Write trigger-flash-and-health.md**

Write `plugins/claw-mux/skills/claw-mux/references/trigger-flash-and-health.md`:
...
- [ ] **Step 5: Write notifications.md (NEW content)**
...
cmux browser "$SURFACE" screenshot --out "$OUT_DIR/screenshot-$TS.png"
...
plugins/claw-mux/skills/claw-mux/references/trigger-flash-and-health.md
