...
<script>
  ...
  var conceptData = {
    ...
    "hook": {
      "category": "platform",
      "title": "Hook",
      "body": "An automation handler that reacts to Claude Code events (tool use, session start, etc.).",
    ...
    "orchestrator-pattern": {
      ...
      "body": "A pattern this report uses to classify plugin architecture. Not an official Claude Code term.",
      "link": "#plugin-profile"
    }
  };
