...
This document defines the 9-section structure for vision-plan HTML reports. The orchestrator reads this file and passes its content to the visual-report-writer agent, which renders each section using the HTML pattern snippets below.
